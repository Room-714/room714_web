...
// Sin try/catch a propósito: "no existe" devuelve null (→ 404) y un error de
// BD se propaga (→ 5xx). Tragarse el error convertía una caída de la BD en un
// 200 con title "Post not found" y la canónica de la portada: un soft-404 que
// puede hacer que Google desindexe el post.
