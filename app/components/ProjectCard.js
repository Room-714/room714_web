      ...
      <div className="py-4 px-6">
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-4">
            <span
              className={`font-black font-hand text-xl md:text-3xl ${isOpen ? "text-red-600" : "text-gray-400"}`}
            >
              {project.id}
            </span>
            <h3
              className={`font-bold font-hand text-xl md:text-3xl transition-colors ${isOpen ? "text-black" : "text-gray-500"}`}
            >
              {project.title}
            </h3>
          </div>
          ...
          <div className="overflow-hidden">
            <div className="flex flex-col md:flex-row gap-10">
              ...
              <div className="flex-1 space-y-4">
                <div>
                  <p className="font-hand text-xl md:text-2xl font-black text-red-600 mb-1">
